...
@Component({
  templateUrl: './product-version-delete-dialog.component.html',
})
export class ProductVersionDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.productVersionService.delete(id).subscribe(() => {
      this.eventManager.broadcast('productVersionListModification');

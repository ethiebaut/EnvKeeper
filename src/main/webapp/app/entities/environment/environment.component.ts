...
export class EnvironmentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.environmentService
      ...
      .subscribe(
        (res: HttpResponse<IEnvironment[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEnvironments(): void {
    this.eventSubscriber = this.eventManager.subscribe('environmentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEnvironment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

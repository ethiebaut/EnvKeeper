...
import { EnvironmentGroupComponent } from 'app/entities/environment-group/environment-group.component';
...
describe('Component Tests', () => {
  describe('EnvironmentGroup Management Component', () => {
    let comp: EnvironmentGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnvironmentGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.environmentGroups && comp.environmentGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

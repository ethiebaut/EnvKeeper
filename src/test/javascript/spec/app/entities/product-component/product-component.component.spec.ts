...
import { ProductComponentComponent } from 'app/entities/product-component/product-component.component';
...
describe('Component Tests', () => {
  describe('ProductComponent Management Component', () => {
    let comp: ProductComponentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductComponentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productComponents && comp.productComponents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

  ...
  describe('Build Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BuildComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.builds && comp.builds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

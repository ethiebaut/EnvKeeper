...
describe('Service Tests', () => {
  describe('Build Service', () => {
    ...
    let elemDefault: IBuild;
    let expectedResult: IBuild | IBuild[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Build(0, 'AAAAAAA', 'AAAAAAA', BuildStatus.IN_PROGRESS, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Build', () => {
        ...
        service.create(new Build()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Build', () => {
        const returnedFromService = Object.assign(
          {
            buildUrl: 'BBBBBB',
            buildName: 'BBBBBB',

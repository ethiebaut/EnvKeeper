...
describe('Service Tests', () => {
  describe('Deployment Service', () => {
    ...
    let elemDefault: IDeployment;
    let expectedResult: IDeployment | IDeployment[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DeploymentService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Deployment(0, currentDate, currentDate, 'AAAAAAA', DeploymentStatus.IN_PROGRESS, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Deployment', () => {
        ...
        service.create(new Deployment()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Deployment', () => {
        const returnedFromService = Object.assign(
          {
            startTime: currentDate.format(DATE_TIME_FORMAT),
            endTime: currentDate.format(DATE_TIME_FORMAT),

...
import { ProductVersionComponent } from 'app/entities/product-version/product-version.component';
...
describe('Component Tests', () => {
  describe('ProductVersion Management Component', () => {
    let comp: ProductVersionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductVersionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productVersions && comp.productVersions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
